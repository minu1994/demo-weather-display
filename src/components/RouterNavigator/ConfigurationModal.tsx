...
import {GB_LONDON_ID, GERMAN_BERLIN_ID, ITALY_MILAN_ID, ITALY_ROME_ID} from "../../Utils/API Utils";
...
export const ConfigurationModal: FC<Props> = (
    ...
    const [selectedOptions, setSelectedOptions] = useState<any>(useSelector (
        ...
        <Modal show={showModalConfig} onHide={() => setShowModalConfig(false)}>
            ...
            <Modal.Body>
                <DivWithPadding>
                    ...
                    <input style={{marginTop: 5}} className={"col-12"}  value={inputValue}
