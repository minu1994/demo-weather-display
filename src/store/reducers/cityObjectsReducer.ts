...
import {CityState, EDIT_CITY_OBJECTS, EditCityIdAction} from "../actions/ActiontTypes";
...
function cityObjectsReducer(state: CityState = initState, action: EditCityIdAction): any {
    switch(action.type) {
